<?php
/**
 * SlideshowSEPluginInstaller takes care of setting up slideshow setting values and transferring to newer version without
 * losing any settings.
 *
 * @since 2.1.20
 * @author Stefan Boonstra
 */
class SlideshowSEPluginInstaller
{
	...
	static function init()
	{
		...
		if ($currentVersion == null ||
			self::firstVersionGreaterThanSecond(SlideshowSEPluginMain::$version, $currentVersion))
		{
	...
	private static function update($currentVersion)
	{
		...
		// Set new version
		update_option(self::$versionKey, SlideshowSEPluginMain::$version);
	}
		...
		if (is_array($customStyles))
		{
			foreach ($customStyles as $customStyleKey => $customStyleValue)
			{
				...
				$customStyle .= PHP_EOL . PHP_EOL . '.slideshow_container .slideshow_loading_icon {' . PHP_EOL .
					...
					"\t" . 'background: url(\'%plugin-url%/images/SlideshowSEPlugin/loading-icon-128x128.gif\') no-repeat;' . PHP_EOL .
	...
	private static function updateV1toV2()
	{
		...
		foreach ($posts as $post)
		{
			...
			$data = array( // $data : array([prefix_settingName] => array([inputType], [value], [default], [description], array([options]), array([dependsOn], [onValue]), 'group' => [groupName]))
				'style_style' => array('select', '', $defaultData['style_style'], __('The style used for this slideshow', 'slideshow-se'), array('light' => __('Light', 'slideshow-se'), 'dark' => __('Dark', 'slideshow-se'), 'custom' => __('Custom', 'slideshow-se'))),
				'style_custom' => array('textarea', '', $defaultData['style_custom'], __('Custom style editor', 'slideshow-se'), null, array('style_style', 'custom')),
				'setting_animation' => array('select', '', $defaultData['setting_animation'], __('Animation used for transition between slides', 'slideshow-se'), array('slide' => __('Slide', 'slideshow-se'), 'fade' => __('Fade', 'slideshow-se')), 'group' => __('Animation', 'slideshow-se')),
				'setting_slideSpeed' => array('text', '', $defaultData['setting_slideSpeed'], __('Number of seconds the slide takes to slide in', 'slideshow-se'), 'group' => __('Animation', 'slideshow-se')),
				'setting_descriptionSpeed' => array('text', '', $defaultData['setting_descriptionSpeed'], __('Number of seconds the description takes to slide in', 'slideshow-se'), 'group' => __('Animation', 'slideshow-se')),
				'setting_intervalSpeed' => array('text', '', $defaultData['setting_intervalSpeed'], __('Seconds between changing slides', 'slideshow-se'), 'group' => __('Animation', 'slideshow-se')),
				'setting_slidesPerView' => array('text', '', $defaultData['setting_slidesPerView'], __('Number of slides to fit into one slide', 'slideshow-se'), 'group' => __('Display', 'slideshow-se')),
				'setting_width' => array('text', '', $defaultData['setting_width'], __('Width of the slideshow, set to parent&#39;s width on 0', 'slideshow-se'), 'group' => __('Display', 'slideshow-se')),
				'setting_height' => array('text', '', $defaultData['setting_height'], __('Height of the slideshow', 'slideshow-se'), 'group' => __('Display', 'slideshow-se')),
				'setting_descriptionHeight' => array('text', '', $defaultData['setting_descriptionHeight'], __('Height of the description boxes', 'slideshow-se'), 'group' => __('Display', 'slideshow-se')),
				'setting_stretchImages' => array('radio', '', $defaultData['setting_stretchImages'], __('Fit image into slide (stretching it)', 'slideshow-se'), array('true' => $yes, 'false' => $no), 'group' => __('Display', 'slideshow-se')),
				'setting_showDescription' => array('radio', '', $defaultData['setting_showDescription'], __('Show title and description', 'slideshow-se'), array('true' => $yes, 'false' => $no), 'group' => __('Display', 'slideshow-se')),
				'setting_hideDescription' => array('radio', '', $defaultData['setting_hideDescription'], __('Hide description box, it will pop up when a mouse hovers over the slide', 'slideshow-se'), array('true' => $yes, 'false' => $no), array('setting_showDescription', 'true'), 'group' => __('Display', 'slideshow-se')),
				'setting_play' => array('radio', '', $defaultData['setting_play'], __('Automatically slide to the next slide', 'slideshow-se'), array('true' => $yes, 'false' => $no), 'group' => __('Control', 'slideshow-se')),
				'setting_loop' => array('radio', '', $defaultData['setting_loop'], __('Return to the beginning of the slideshow after last slide', 'slideshow-se'), array('true' => $yes, 'false' => $no), 'group' => __('Control', 'slideshow-se')),
				'setting_controllable' => array('radio', '', $defaultData['setting_controllable'], __('Activate buttons (so the user can scroll through the slides)', 'slideshow-se'), array('true' => $yes, 'false' => $no), 'group' => __('Control', 'slideshow-se')),
				'setting_controlPanel' => array('radio', '', $defaultData['setting_controlPanel'], __('Show control panel (play and pause button)', 'slideshow-se'), array('true' => $yes, 'false' => $no), 'group' => __('Control', 'slideshow-se')),
			);
