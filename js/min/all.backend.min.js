...
/**
 * Global namespace for backend bundles. Must load before modules that assign
 * slideshow_jquery_image_gallery_backend_script.editSlideshow, .generalSettings, etc.
 */
window.slideshow_jquery_image_gallery_backend_script = window.slideshow_jquery_image_gallery_backend_script || {};
...
window.slideshow_jquery_image_gallery_backend_script.editSlideshow = function () {
  ...
  self.init = function () {
    ...
    if (body && body.classList.contains('post-type-slideshow') && (body.classList.contains('post-php') || body.classList.contains('post-new-php') || body.classList.contains('block-editor-page'))) {
...
window.slideshow_jquery_image_gallery_backend_script.editSlideshow.slideManager = function () {
  ...
  self.isSlideshowEditScreen = function () {
    ...
    return body.classList.contains('post-php') || body.classList.contains('post-new-php') || body.classList.contains('block-editor-page');
  };
  ...
  self.bindDelegatedSlideControls = function () {
    ...
    $(document).off('click.slideshowSEOpen', '.open-slides-button').on('click.slideshowSEOpen', '.open-slides-button', function (event) {
    ...
    $(document).off('click.slideshowSEClose', '.close-slides-button').on('click.slideshowSEClose', '.close-slides-button', function (event) {
      event.preventDefault();
      $('.sortable-slides-list .sortable-slides-list-item').each(function (listItemIndex, listItem) {
        var $listItem = $(listItem);
        if ($listItem.find('.inside').is(':visible')) {
    ...
    $(document).off('click.slideshowSEInsText', '.slideshow-insert-text-slide').on('click.slideshowSEInsText', '.slideshow-insert-text-slide', function (event) {
      event.preventDefault();
      self.insertTextSlide(event);
    });
    $(document).off('click.slideshowSEInsVideo', '.slideshow-insert-video-slide').on('click.slideshowSEInsVideo', '.slideshow-insert-video-slide', function (event) {
      event.preventDefault();
      self.insertVideoSlide(event);
    });
    $(document).off('click.slideshowSEInsImg', '.slideshow-insert-image-slide').on('click.slideshowSEInsImg', '.slideshow-insert-image-slide', function (event) {
      self.mediaUploader(event);
    });
    $(document).off('click.slideshowSEDelete', '.slideshow-delete-slide').on('click.slideshowSEDelete', '.slideshow-delete-slide', function (event) {
      event.preventDefault();
  ...
  self.init = function () {
    ...
    $(window).off('load.slideshowSESM').on('load.slideshowSESM', self.refreshSlideChrome);
  ...
  self.deleteSlide = function ($slide) {
    ...
    if (typeof extraData === 'object' && typeof extraData.localization === 'object' && extraData.localization.confirm !== undefined && extraData.localization.confirm.length > 0) {
  ...
  self.removeDescriptionEditor = function ($slide) {
    var $textarea = $slide.find('.slideshow-description-editor-field textarea.description');
    var editorId = $textarea.attr('id');
    if (!editorId || typeof wp === 'undefined' || !wp.editor || typeof wp.editor.remove !== 'function') {
      return;
    }
  ...
  self.initTextSlideDescriptionEditor = function ($textSlide) {
    var externalData, editorSettings, $field, $textarea, editorId;
    ...
    if (!externalData || typeof externalData.descriptionEditor !== 'object') {
      return;
    }
    ...
    editorId = 'slideshow-text-description-' + Date.now() + '-' + Math.floor(Math.random() * 10000);
  ...
  self.mediaUploader = function (event) {
    event.preventDefault();
    var uploaderTitle, externalData;
    ...
    externalData = window.slideshow_jquery_image_gallery_backend_script_editSlideshow;
    uploaderTitle = '';
    if (typeof externalData === 'object' && typeof externalData.localization === 'object' && externalData.localization.uploaderTitle !== undefined && externalData.localization.uploaderTitle.length > 0) {
...
window.slideshow_jquery_image_gallery_backend_script.generalSettings.customStyles = function () {
   ...
   */
  self.init = function () {
    if (!window.slideshow_jquery_image_gallery_backend_script.generalSettings.isCurrentPage) {
      return;
    }
  ...
  self.activateActionButtons = function () {
    ...
    $('.custom-styles-tab .styles-list .style-action.style-default').click(function (event) {
      var $this = $(event.currentTarget),
        ...
        externalData = window.window.slideshow_jquery_image_gallery_backend_script_generalSettings,
      ...
      if (typeof externalData === 'object') {
        ...
        if (typeof externalData.localization === 'object' && externalData.localization.newCustomizationPrefix !== undefined && externalData.localization.newCustomizationPrefix.length > 0) {
          title = externalData.localization.newCustomizationPrefix + ' - ' + title;
        }

        // Get custom styles key
        if (typeof externalData.data === 'object' && externalData.data.customStylesKey !== undefined && externalData.data.customStylesKey.length > 0) {
  ...
  self.activateDeleteButtons = function () {
    $('.custom-styles-tab .styles-list .style-delete, .custom-styles-tab .custom-style-templates .custom-styles-list-item .style-delete').click(function (event) {
      ...
      if (typeof externalData === 'object' && typeof externalData.localization === 'object' && externalData.localization.confirmDeleteMessage !== undefined && externalData.localization.confirmDeleteMessage.length > 0) {
...
var slideshow_jquery_image_gallery_backend_script = window.slideshow_jquery_image_gallery_backend_script;
slideshow_jquery_image_gallery_backend_script.generalSettings = function () {
  ...
  self.activateUserCapabilities = function () {
    $('input').change(function (event) {
      ...
      if (capability === editSlideshowsCapability && !$this.attr('checked')) {
      ...
      else if (capability === addSlideshowsCapability || capability === deleteSlideshowsCapability) {
  ...
  self.activateShortcodeInserter = function () {
    $('.insertSlideshowShortcodeSlideshowInsertButton').click(function () {
      ...
      if (typeof extraData === 'object') {
        if (typeof extraData.data === 'object' && extraData.data.shortcode !== undefined && extraData.data.shortcode.length > 0) {
          shortcode = extraData.data.shortcode;
        }
        if (typeof extraData.localization === 'object' && extraData.localization.undefinedSlideshow !== undefined && extraData.localization.undefinedSlideshow.length > 0) {
...
!function() {
"use strict";
/* harmony import */ var _backend_backend_namespace_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(497);
/* harmony import */ var _backend_backend_namespace_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_backend_backend_namespace_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _backend_generalSettings_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(974);
/* harmony import */ var _backend_generalSettings_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_backend_generalSettings_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _backend_generalSettings_navigation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(741);
/* harmony import */ var _backend_generalSettings_navigation_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_backend_generalSettings_navigation_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _backend_generalSettings_customStyles_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(44);
/* harmony import */ var _backend_generalSettings_customStyles_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_backend_generalSettings_customStyles_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _backend_editSlideshow_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(359);
/* harmony import */ var _backend_editSlideshow_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_backend_editSlideshow_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _backend_editSlideshow_slideManager_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(353);
/* harmony import */ var _backend_editSlideshow_slideManager_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_backend_editSlideshow_slideManager_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _backend_shortcode_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(947);
/* harmony import */ var _backend_shortcode_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_backend_shortcode_js__WEBPACK_IMPORTED_MODULE_6__);
/**
